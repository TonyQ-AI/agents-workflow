...
description: "涓€閿畨瑁?Workflow Dualmode 宸ヤ綔娴佲€斺€旇銆岃宸ヤ綔娴併€嶈嚜鍔ㄦ悶瀹?
---

# Workflow 涓€閿畨瑁呭櫒

褰撶敤鎴疯銆岃宸ヤ綔娴併€嶃€乣瀹夎 Workflow Dualmode`銆乣/workflow-installer` 鏃讹紝鎸変互涓嬫楠ゆ墽琛屻€?
**濡傛灉鐢ㄦ埛璇淬€屽崌绾у伐浣滄祦銆?*锛岃烦杞埌鏈€鍚庣殑銆屼竴閿崌绾с€嶉儴鍒嗐€?
## 涓€鍙ヨ瘽瀹夎娴佺▼

### 姝ラ1锛氬厠闅嗕粨搴?
```powershell
# 鍏嬮殕鍒颁复鏃剁洰褰?git clone --depth 1 https://github.com/TonyQ-AI/Workflow-Dualmode.git $env:TEMP/Workflow-Dualmode

# 濡傛灉 git clone 澶辫触锛堢綉缁滈棶棰橈級锛屽皾璇曚笅杞?ZIP锛?# Invoke-WebRequest -Uri "https://github.com/TonyQ-AI/Workflow-Dualmode/archive/refs/heads/main.zip" -OutFile $env:TEMP/workflow.zip
...
鍦?`workflow.toml` 鎴栧搴旈厤缃枃浠朵腑娣诲姞锛?
```toml
[[plugins]]
...
### 姝ラ7锛氭姤鍛婄粨鏋?
```
鉁?Workflow Dualmode 宸ヤ綔娴佸畨瑁呭畬鎴愶紒
...
璇︾粏鏂囨。锛?  https://github.com/TonyQ-AI/Workflow-Dualmode
```
...
git clone --depth 1 https://github.com/TonyQ-AI/Workflow-Dualmode.git $env:TEMP/rw-upgrade
