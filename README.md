# Reasonix Workflow 完整技术说明书

> **多 Agent 协同开发工作流** — 8 阶段全流程自动化，26 个技能，4 个多模态 MCP 工具，6 层防幻觉机制
>
...
└─────────────────────────────────────────────────────────────────────────┘
         ...
         │  ┌──────────────────┐  ┌──────────────────┐              │
         │  │  MiMo API        │  │  MCP Server       │              │
         │  │  (xiaomimimo)    │◄─│  (dist/index.js)  │◄── Skills    │
         │  └──────────────────┘  └──────────────────┘              │
         │                                                          │
         └──────────────────────────────────────────────────────────┘
```
...
MIMO_API_KEY=sk-xxx              # 仅多模态 MCP 需要
```
