...
AI 会自动克隆本仓库（https://github.com/TonyQ-AI/Workflow-Dualmode）并完成全部安装。

或者直接说 `/Workflow-Dualmode` 也能触发安装。
...
```bash
git clone --depth 1 https://github.com/TonyQ-AI/Workflow-Dualmode.git
```
...
```toml
[skills]
paths = ["Workflow-Dualmode/skills"]
```
...
- GitHub 仓库：https://github.com/TonyQ-AI/Workflow-Dualmode
